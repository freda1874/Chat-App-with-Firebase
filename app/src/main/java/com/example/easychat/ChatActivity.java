...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseUtil.getOtherProfilePicStorageRef(otherUser.getUserId()).getDownloadUrl()
                .addOnCompleteListener(t -> {
                    if (t.isSuccessful()) {
                        Uri uri = t.getResult();
                        AndroidUtil.setProfilePic(this, uri,
                                imageView);
                    }
                });
    ...
    void sendMessageToUser(String message) {
        ...
        ChatMessageModel chatMessageModel = new ChatMessageModel(message,
                FirebaseUtil.currentUserId(), Timestamp.now());
    ...
    void callApi(JSONObject jsonObject) {
        ...
        String url = "POST https://fcm.googleapis.com/v1/projects/easy-chat-backend-8633e/messages:send";
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization",
                        "lIAa6wxuRWNL2_PL5nY3rHbeNQVHxNVuZpProetn84E")
                .build();
